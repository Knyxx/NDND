...
- aiming for 1-1.5 hour chunks, breaks in between
- remember to raise hands if you'd like to contribute or interact
- all characters EXP should have 1,499 EXP (Level 3)
- remove two rations for nights camping along the way
- [[Wuskan Dhyrktelonis|Wuskan]] got hustled by merchant, got some basic gears
- set scene
	- [[Party]] had set off in search of [[Tor Emberdelve|Tor]] at ruins east of the [[Crossroads Encampment]]
	- Uneventful days travelling though the peaceful mountain range
	- They camp in a ring of standing stones with cliff to one side
	- Three paths leading away from camp, West to the [[Crossroads Encampment]], East, and South
...
- [[Party]] decides to go left, finds two men searching a ruined campsite
...
>- [[Robust.Garden.Bot (RGB)|RGB]] casts [[Longstrider]]: [[Shimmer]] +10 [[Movement Speed|MS]] for 1 hour
>- [[Shimmer]] (uses [[Inspiration]]) to pin second man for questioning
>- Party: 200EXP, various items (2G) - party loot to be sold
>- Individual: 33EXP, one arrow ([[Elara Ashbud|Elara]]), head ([[Gar-ruk Oxfell|Gar-ruk]])

>[!info] Decision - [[Inspiration]]
...
- [[Elara Ashbud|Elara]] notices movement in bushes
- [[Gar-ruk Oxfell|Gar-ruk]] checks on [[Robust.Garden.Bot (RGB)|RGB]] to learn more about them
- [[Elara Ashbud|Elara]] uses a large leaf to cover their tracks as they leave - inspiration

>[!info] Decision - Dropped Items
>- Dropping an item/weapon/shield does not cost an action/bonus action

- [[Party]] return to road an take right path, travel for half an hour, reach pathway up steep hill
- Climb pathway and come across a camp, sounds of people inside
- Enter camp, see men running towards them yelling and brandishing weapons
- [[Party]] challenge the men
- [[Gar-ruk Oxfell|Gar-ruk]] holding up the head saying "hey guys, it's me, Eric!", then throws the head at them

>[!danger] Encounter - [[Bandit Hideout]]
>- kill three bandits, two bandit scouts, one bandit captain
>- [[Robust.Garden.Bot (RGB)|RGB]] casts [[Shield of Faith]]: [[Elara Ashbud|Elara]] +2 [[Armour Class|AC]] for 10 minutes
>- Party: 2070EXP, Healing Potion, 4 Gemstones (10G each) - party loot to be sold
>- Individual: 345EXP, three arrows ([[Elara Ashbud|Elara]]), John's Head ([[Gar-ruk Oxfell|Gar-ruk]])
- [[Gar-ruk Oxfell|Gar-ruk]] looks for identifying marks on bandits, find none
...
Everyone start next session with inspiration, tell them
