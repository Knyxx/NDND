...
#### Insulating Layers.
You have advantage on ability checks made to resist nonmagical cold weather, such as checks to avoid exhaustion from exposure, or to assess safety levels of cold environments and frigid weather e.g. the stability of ice.
This does not give resistance to cold damage—only natural environmental cold.

Notes: Advantage: Ability Checks, player, during a short rest, Buff, Outerwear
